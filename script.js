...
const biscuitImage = document.querySelector('.screen-01 img')
const button = document.querySelector('.screen-02 button')

biscuitImage.addEventListener('click', goToScreen2)
...
const text = document.querySelector('.screen-02 p')
